...
class LotteryServiceTest extends TestCase
{
    public function testGenerateDezenas()
    {
        ...
        $this->assertEquals(count($dezenas), count(array_unique($dezenas)));  // Verifica que as dezenas são únicas
    }
    ...
    public function testGenerateTickets()
    {
        ...
        $this->assertCount(2, $tickets);  // Verifica se dois bilhetes foram gerados
    }
}
?>
